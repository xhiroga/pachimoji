...
export const metadata: Metadata = {
  ...
  description: "パチンコでよく見る豪華な文字を簡単に作成できる無料のオンライン3Dツール。チラシ、ポスター、SNS投稿用の派手な文字デザインが誰でも簡単に作れます。装甲明朝、玉ねぎ楷書など日本語フォント対応。",
  keywords: [
    "3D文字作成", "パチンコ文字", "3Dテキストエディター", "日本語フォント", "チラシデザイン", 
    "ポスターデザイン", "装甲明朝", "玉ねぎ楷書", "Noto Sans JP", "3D text", 
    "pachinko style", "Japanese fonts", "online 3d editor", "text effects", "SNS画像"
  ],
